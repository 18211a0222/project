		...
		<form action="AdminController">
			...
			<div class="form-group my-3">
				<label>Enter User Name : </label> <input type="text"
					value="${user.username}" class="form-control my-3"
					name="userName" required="required">
			</div>

			<div class="form-group my-3">
				<label>Enter Full Name :</label> <input type="text"
					value="${user.fullname}" class="form-control my-3"
					name="fullName">
			</div>

			<div class="form-group my-3">
				<label>Enter Email : </label> <input type="text"
					value="${user.email}" class="form-control my-3"
					name="email">
			</div>
			<div class="form-group my-3">
				<label>Enter Mobile Number : </label> <input type="text"
					value="${user.mob}" class="form-control my-3"
					name="mobileNo">
			</div>
